...
------------------------------------------------------------------------
\newpage
```{r echo=FALSE, fig.cap="2018 monthly Ozone levels", fig.height=3}

#2018 monthly ozone levels

#change month to factor == with 12 levels, labeled w/ month names
...
```{r echo=FALSE, fig.cap="2019 monthly Ozone levels", fig.height=3}
epa_data %>% 
  filter(Year==2019) %>% 
  drop_na(Ozone)  %>%
  ggplot(aes(x = Month, y = Ozone)) + 
...
## Git Repository
https://github.com/mifinch/EDE_Fall2025.git  
