...
length(EPAair$Ozone) #8976 observations; mean is good est of true pop
...
Ozone.plot <- ggplot(EPAair, aes(x = Ozone)) +
  ...
  geom_vline(xintercept = 50, color = "#238b45", lty = 2, size = 0.9) + #add vertical line
  scale_x_continuous(expand = c(0, 0)) + 
  scale_y_continuous(expand = c(0, 0))
print(Ozone.plot)

# Format as a GLM
O3.onesample2 <- lm(Ozone ~ 1, EPAair) #use 1 because there is no explanatory variable
O3.onesample2
```
...
O3.twosample #p<0.05 reject null

# Format as a GLM - is year a predictor of ozone levels?
O3.twosample2 <- lm(EPAair$Ozone ~ EPAair$Year)
summary(O3.twosample2) #p<0.05 reject null; year is a predictor of ozone levels
