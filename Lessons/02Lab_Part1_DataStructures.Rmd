...
# Inverts the logic, switches T and F
!vector3
...
```{r Creating Matrices}
# Matrices ----
matrix1 <- matrix(1:20, nrow = 5,ncol = 4) # create matrix values 1 thru 20 filled by column
matrix1
#matrix1 has 5 rows and 4 columns

matrix2 <- matrix(1:20, nrow = 5, ncol = 4, byrow = TRUE) # create matrix 1 thru 20 filled by rows
matrix2
...
matrix1[4, 1] # 4th row, 1st column

matrix1[4,  ] # all of row 4

matrix1[ , 3] # all of column 3

matrix1[c(12, 14)] # 12th and 14th item

matrix1[c(12:14)] # 12th thru 14th item (slices)

matrix1[2:4, 1:3] # 2 thru 4 row, 1 thru 3 column
...
names(dataframe1) <- c("ID","Color","Passed"); View(dataframe1) # update columns
