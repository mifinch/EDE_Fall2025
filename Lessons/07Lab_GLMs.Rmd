...
pm_regression<- lm(data=EPAair, PM2.5 ~ Ozone)
summary(pm_regression) #r2 = 0.1316, p < 2.2e-16
...
EPAair_Corr <- cor(EPAair.subset)

corrplot(EPAair_Corr, method = "ellipse")
corrplot.mixed(EPAair_Corr, upper="ellipse") #mean_lat is next greatest predictor
...
summary(OzoneBest.regression) #R-squared improved to 0.19
```
